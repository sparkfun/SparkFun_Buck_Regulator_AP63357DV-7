...
??? tip "Line and Load Regulation"
	Users should expect a line and load regulation close to the charts presented Figures 27 and 28 in the [datasheet](../component_documentation/AP63356-AP63357.pdf) *(i.e. 5.0 &plusmn;0.2V)*. While these vary with the load current and cooling, we didn't see an output voltage below 5V in our tests.
...
(1) V<sub>ON</sub> is the rising edge VIN voltage to enable the regulator and is greater than 3.6V<br>
(2) V<sub>OFF</sub> is the falling edge VIN voltage to disable the regulator and is greater than 3.18V
{ .annotate }
...
A platted copper pad is provided on the back of the boards, where users can add a heat sink to dissipate excess heat generated by the AP63357. While the pad size is slightly different between each board, they both are able to accommodate the [copper heatsink](https://www.sparkfun.com/products/18704) in our catalog.
